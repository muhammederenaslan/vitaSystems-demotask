        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Authors List</h2>
                </header>
                <div class="card-body">
                    <p>Click authors name for authors detail.</p>
                    <a href="{{ route('admin.add.author') }}" class="btn btn-primary">Add New Author</a>
                        ...
                        <tbody>
                            @foreach ($authors as $author)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.author.detail', ['id' => $author->id]) }}">{{ $author->name }}</a></td>


                                    <td> {{ $author->surname }}</td>

                                    <td>
                                        <form method="POST" action="{{ route('admin.delete.author', ['id' => $author->id]) }}">
                                            @csrf
                                            @method('DELETE')  
