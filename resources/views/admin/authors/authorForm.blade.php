  ...
  <div class="row">
    <div class="col-lg-12">
        <section class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal form-bordered" action="{{ route('admin.add.author.post') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="surname" class="form-control" id="author_surname" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Books</label>
                        <div class="col-lg-6">
                            <select name="books[]" class="form-control select2" id="author_books" multiple="multiple">
