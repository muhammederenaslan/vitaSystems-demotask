    ...
    <div class="row">
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.add.book.form') }}" class="btn btn-primary">Add New Book</a>
                        ...
                        <tbody>
                            @foreach ($books as $book)
                                <tr>
                                    ...
                                    <td>
                                        <form method="GET" action="{{ route('admin.book.detail', ['id' => $book->id]) }}">
                                            @csrf
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('admin.book.delete', ['id' => $book->id]) }}">
                                            @csrf
                                            @method('DELETE') 
                                            <button type="submit">Delete this record.</button>
                                        </form>
                                    </td>
