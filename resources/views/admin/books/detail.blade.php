  ...
  <div class="row">
    <div class="col-lg-12">
        <section class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.edit.book') }}" method="POST">
                    @csrf
            
                    <div class="form-group row">
                        <label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Book Isbn</label>
                        <div class="col-lg-6">
                            <input type="number" name="bookISBN" class="form-control" id="book_price" value="{{ $book->isbn }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="bookName" class="form-control" id="book_name" value="{{ $book->name }}">
                        </div>
                    </div>
            
                    <div class="form-group row">
                        <label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Authors</label>
                        <div class="col-lg-6">
                            <select name="authorID" class="form-control" id="author_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="bookDetail" class="form-control" id="book_detail" rows="4">{{ $book->detail }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="bookPrice" class="form-control" id="book_price" value="{{ $book->price }}">
                        </div>
                    </div>
            
                    <div class="form-group row">
                        <label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Book Stock</label>
                        <div class="col-lg-6">
                            <input type="number" name="bookQuantity" class="form-control" id="book_price" value="{{ $book->quantity }}">
                        </div>
                    </div>
